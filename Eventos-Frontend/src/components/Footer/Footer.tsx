    ...
    <FooterWrapper>
      <FooterContainer>
        <Column style={{ flex: 1 }}>
          ...
          <Text>Fornecendo Ingressos de qualidade para novas jornadas.</Text>
          <SocialIcons>
            <a href="https://www.instagram.com/pedrogabrieltoscano">
        ...
        <Column style={{ flex: 0.8 }}>
          ...
          <LinkList>
            <LinkItem>
              <a href="https://wa.me/554598376536">Whatsapp</a>
            </LinkItem>
          </LinkList>
        </Column>
      ...
      <CopyrightContainer>
        <div>Copyright © IngressaMais 2025 | All Rights Reserved</div>
      </CopyrightContainer>
    </FooterWrapper>
  );
};
